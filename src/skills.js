    ...
    steps: [
      {
        ...
        tier: 1,
        name: '破甲斬 I',
        description: '以銳利的斬擊破壞敵人的防禦，造成攻擊力×80%傷害，並降低目標防禦力20%，持續1回合。',
        kind: 'attack',
        power: 8,
        mpCost: 8,
        requiredLevel: 10,
        critChance: 0.05,
        defenseDownDuration: 1,
        defenseDownRatio: 0.2,
      },
      {
        id: 'armor_break_2',
        tier: 2,
        name: '破甲斬 II',
        description: '以銳利的斬擊破壞敵人的防禦，造成攻擊力×90%傷害，並降低目標防禦力30%，持續1回合。',
        kind: 'attack',
        power: 20,
        mpCost: 14,
        requiredLevel: 22,
        critChance: 0.1,
        defenseDownDuration: 1,
        defenseDownRatio: 0.3,
      },
      {
        id: 'armor_break_3',
        tier: 3,
        name: '破甲斬 III',
        description: '以銳利的斬擊破壞敵人的防禦，造成攻擊力×100%傷害，並降低目標防禦力40%，持續1回合。',
        kind: 'attack',
        power: 35,
        mpCost: 20,
        requiredLevel: 34,
